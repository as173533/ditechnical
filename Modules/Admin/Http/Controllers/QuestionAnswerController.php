...
class QuestionAnswerController extends AdminController {
    ...
    public function store(Request $request) {
        ...
        if ($validator->passes()) {
            ...
            //--- Logic Section Ends
            //--- Redirect Section        
            return redirect()->route('admin-question-answer-index')->with('success_msg', 'Question Answer Created successfully.');
        } else {
    ...
    public function update(Request $request, $id) {
        ...
        if ($validator->passes()) {
            ...
            //--- Logic Section Ends
            //--- Redirect Section     
            return redirect()->route('admin-question-answer-index')->with('success_msg', 'Question Answer Updated successfully.');
        } else {
            return redirect()->back()->withErrors($validator)->withInput()->with('error_msg', 'Something went wrong please check your input.');
        }
        //--- Redirect Section Ends            

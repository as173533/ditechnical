...
<div class="user-left-side">
    ...
    <ul>
        ...
        <li class="{{ ($controller=='EnquiryController') ? 'active' : '' }}"><a href="{{Route('enquiry')}}"><i class="fa fa-commenting"></i> Enquiry</a></li>
        <li class="{{ ($controller=='FranchiseRequestController') ? 'active' : '' }}"><a href="{{Route('franchise-request')}}"><i class="fa fa-commenting"></i> Franchise Request</a></li>
        ...
        <li class="{{ ($controller=='GalleryController') ? 'active' : '' }}"><a href="{{Route('admin-gallery-index')}}"><i class="fa fa-picture-o" aria-hidden="true"></i> Gallery</a></li>
        ...
        <li class="{{ ($controller=='QuestionAnswerController') ? 'active' : '' }}"><a href="{{Route('admin-question-answer-index')}}"><i class="fa fa-question" aria-hidden="true"></i>Question Answer</a></li>
        ...
        <li class="{{ ($controller=='StudentController') ? 'active' : '' }}"><a href="{{Route('students')}}"><i class="fa fa-user"></i> Student</a></li>

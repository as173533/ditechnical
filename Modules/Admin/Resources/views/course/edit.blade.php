            ...
            <div class="portlet-body form">
                <form method="post" action="{{route('admin-course-update',$data->id)}}" class="form-horizontal" enctype="multipart/form-data">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            <div class="col-md-10">
                                <a href="{{isset($data->study_material)?URL::asset('public/uploads/course/'.$data->study_material):''}}" class="btn btn-xs btn-primary pull-left" target="_blank"><i class="fa fa-eye"></i> study material</a><br/>
                            </div>
                        </div>
                        <div class="form-group">
                            <div class="col-md-10">

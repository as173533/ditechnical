...
<ul class="page-breadcrumb breadcrumb">
    ...
    <li>
        <a href="{{Route('admin-question-answer-index')}}">Question Answer</a>
        <i class="fa fa-circle"></i>
    </li>
    <li>
        ...
        <div class="portlet light bordered">
            <div class="portlet-title">
                <div class="caption">
                    ...
                    <span class="caption-subject font-red-sunglo bold uppercase">Update Advertisement </span>
                </div>
            </div>
            <div class="portlet-body form">
                <form method="post" action="{{route('admin-question-answer-update',$data->id)}}" class="form-horizontal" enctype="multipart/form-data">
                    {{csrf_field()}}
                            ...
                            <div class="col-md-10">
                                <select id="course"  name="course"  class="form-control">
                                    ...
                                    @foreach($courses as $course)
                                      <option value="{{ $course->id }}"  {{ (old('course')!="") ? ($course->id==old('course'))?'selected':'' : ($course->id==$data->course)?'selected':''}}>{{ $course->name }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="form-actions">
                        <div class="row">
                            <div class="col-md-12 text-center">
                                <a href="{{Route('admin-question-answer-index')}}" class="btn btn-primary">Cancel</a>

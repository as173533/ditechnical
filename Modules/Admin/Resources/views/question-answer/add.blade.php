    ...
    <div class="col-md-12">
        <div class="portlet light bordered">
            ...
            <div class="portlet-body form">
                <form method="post" action="{{route('admin-question-answer-store')}}" class="form-horizontal" enctype="multipart/form-data">
                    {{csrf_field()}}
                    <div class="form-body">
                            ...
                            <div class="col-md-10">
                                <select id="course"  name="course"  class="form-control">
                                    ...
                                    @foreach($courses as $course)
                                      <option value="{{ $course->id }}"  {{ (old('course')!="") ? ($course->id==old('course'))?'selected':'' : ''}}>{{ $course->name }}</option>
                                    @endforeach
                                </select>

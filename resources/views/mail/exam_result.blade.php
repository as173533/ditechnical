<!-------------------Result----------------->
<div class="container" style="width: 100%; height: auto; background-color: #fff; border: 3px solid #2A1772; border-radius: 50px; background-image: url(https://bct.tekbazaar.in/public/frontend/images/bg.png); background-position: center center; background-size: cover; background-repeat: no-repeat;" >
<table style="width: 100%; padding-top: 20px !important;">
	<tbody>
     <tr style="margin: 0px !important;">
       <td style="text-align: center !important;">
		<img src="{{$qrcode}}" alt="qrcode" style="height:160px;width:160px;">
	  </td>
     </tr>
    </tbody> 
</table>
<h1 style="text-align: center; color: #757336; font-size: 60px; padding: 0px !important; margin: 0px 0px 0px 0px !important;">
    Di Technical <span style="font-size: 35px;">Pvt. Ltd</span>
</h1>
...
<table style="width: 100%; padding: 20px 0px 0px 0px!important; margin:20px 10px 10px 10px!important; border: 1px solid #000;">
	<tbody>
     <tr style="margin: 0px !important; ">
       <td style="text-align: left !important; font-weight: 600; font-size: 22px;">Course Name:</td>
     </tr>
     <tr style="margin: 0px !important; ">
       <td style="text-align: left !important; font-weight: 400; font-size: 18px; line-height: 30px !important;">DCA(Diploma In Computer Science): {{$assigncourse->course->name}}</td>
     </tr>
     <tr style="margin: 0px !important;">
     ...
     <tr style="margin: 0px !important;">
       <td style="text-align: left !important; font-weight: 400; font-size: 18px;  border: 1px solid #000;">Marks Obtained</td>
       <td style="text-align: left !important; font-weight: 400; font-size: 18px;  border: 1px solid #000;">70</td>
     ...
     <tr style="margin: 0px !important;">
      ...
      <tr style="margin: 0px !important;">
       ...
       <td style="text-align: left !important; font-weight: 400; font-size: 18px;  border: 1px solid #000;">AA</td>
...
<table style="width: 100%; overflow-x:auto; padding: 0px !important;">
		<tbody>
			<tr>
				<td style="text-align: center!important;">
					<img src="{{URL::asset('public/frontend/images/Center.png')}}" alt="" style="width: 95px; height: 95px; margin: 0px 0px 0px 0px !important; padding: 0px 0px 0px 0px !important;">
				</td>
				<td style="text-align: center!important;">
					<img src="{{URL::asset('public/frontend/images/Alka.png')}}" alt="" style="width: 152px; height: 38px; margin: 0px 0px 0px 0px !important; padding: 0px 0px 0px 0px !important;">
				</td>
				<td style="text-align: center!important;">
					<img src="{{URL::asset('public/frontend/images/dir.png')}}" alt="" style="width: 208px; height: 76px; margin: 0px 0px 0px 0px !important; padding: 0px 0px 0px 0px !important;">
				</td>
			</tr>
			<tr>
				<td>

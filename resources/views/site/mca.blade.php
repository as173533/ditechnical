            ...
            <div class="col-sm-12">
                <div class="breadcrumb-title-div">
                    <div class="bread-left-side">
                        <h2>Ministry Of Corporate Affairs - Govt. of India</h2>
                    </div>
                    <div class="breadcrumb-ul right-side">
                        <ul>
                            <li><a href="/">HOME</a>/</li>
                            <li><span>Ministry Of Corporate Affairs - Govt. of India</span></li>
                        </ul>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-sm-7">
                    <div class="certificate">
                        <h4>Ministry Of Corporate Affairs - Govt. of India</h4>
                        <img src="{{ URL::asset('public/frontend/images/corporate.jpg') }}" class="img-fluid" alt="">
                    </div>
                </div>
                <div class="col-sm-5">

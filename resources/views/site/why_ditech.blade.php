            ...
            <div class="row">
                <div class="col-sm-7">
                    <div class="exam-sec">
                        ...
                        <p style="text-align: justify;">DI TECHNIAL Advanced Training Institute (DI TECHNIAL) is a national program meant to impart information technology education to people countrywide. Ours is an ISO certified firm and can be useful for computer institute govt. registration/ computer institute registration/ computer center registration. Besides, we undertake requirements related to new computer institute registration. We are supported by a team of diligent individuals, who assist our clients in the complete computer institute registration process. So, contact us anytime.

                        <br><br>DI TECHNIAL provides single source for quality assurance in computer education among the nation's non-formal institutes, After turning out competent IT professionals in large numbers. DI TECHNIAL aims to provides maximum benefits to ALC  and Students with quality...</p>
                        <div class="Director-Message">

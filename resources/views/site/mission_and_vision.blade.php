...
Provide specific need-based computer education and training opportunities for continuous professional development and skill up gradation to in service professionals</p>
                    ...
                    <div class="mission">
                        ...
                        <p>DI TECHNIAL an ISO 9001:2015 Certified Organisation, the initiator of Antarrashtriya Computer Shakshrta Mission shall provide seamless access to sustainable and learner centric quality education, skill up gradation and training to all by using innovative technologies and methodologies for computer literacy programme and ensuring convergence of existing systems for massive human resources required for promoting integrated national development and global understanding. Thus we have :

To establish computer literacy centers countrywide and abroad specially in rural areas.
to impart learning, keeping in quality courses with study materials, well drafted keeping in view the students awareness level as well as the latest development as job oriented and all this for a normal fee.
To extend financial flexibility in terms of scholarships and stipends to deserving candidates.
To proved computer education to grassroots levels.</p>
                    </div>
                </div>
                <div class="col-sm-5">
